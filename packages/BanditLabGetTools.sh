...
if [ "$ARCH = "aarch64" ]; then
	...
	sudo -u ubuntu chmod 755 $HOME/tools/hayabusa/hayabusa-2.16.0-lin-x64-musl
	...
	sudo -u ubuntu sh -c 'wget --no-check-certificate -qO- https://github.com/VirusTotal/vt-cli/releases/download/1.0.0/Linux64.zip|  bsdtar -xvf- -C $HOME/tools/vt && sudo ln -s $HOME/tools/vt/vt /usr/bin/vt'
